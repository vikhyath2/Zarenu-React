...
export const PlatformGithubColorOriginal = ({
  color = "#24292F",
  className,
}) => {
  return (
    <svg
      className={`platform-github-color-original ${className}`}
      fill="none"
      height="48"
      viewBox="0 0 48 48"
      width="48"
    ...
    >
      <g className="g" clipPath="url(#clip0_23_96)">
        <path
          className="path"
          clipRule="evenodd"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_23_96">
...
PlatformGithubColorOriginal.propTypes = {
